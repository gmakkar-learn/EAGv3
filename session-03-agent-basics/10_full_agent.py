...
def search_notes(query: str) -> str:
    ...
    notes = [
        {"title": "Meeting Agenda",
            "content": "Discuss Q3 targets, review agent architecture, plan MCP integration"},
        {"title": "Shopping List", "content": "Milk, eggs, bread, coffee, batteries"},
        {"title": "Project Ideas",
            "content": "Build a stock monitoring agent, voice-based assistant, browser automation tool"},
        {"title": "Travel Plans",
            "content": "Tokyo trip in December, need to book flights and hotel by November"},
        {"title": "Learning Notes",
            "content": "Finish transformer session, practice async Python, read MCP docs"},
    ]
    results = [
        n for n in notes
